...
st.sidebar.header("Lataa tiedostot")
accel_file = st.sidebar.file_uploader("Lataa kiihtyvyysdata (CSV)", type="csv")
gps_file = st.sidebar.file_uploader("Lataa GPS-data (CSV)", type="csv")
...
if accel_file is not None:
    # Piirretään suodatettu kiihtyvyys
    with image_column:
